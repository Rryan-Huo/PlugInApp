class Apartment < ActiveRecord::Base
  # attr_accessible :title, :body
    attr_accessible :address, :city, :state, :zipcode, :neighborhood, :url
    def getNeighbor(zip)
        neig=HA[zip]
        self.neighborhood=neig
        puts neig
    end
    HA = {
60601 => "Loop", 
...
60608 => "Bridgeport, Lower West Side (Pilsen), McKinley Park, Near West Side, North Lawndale, South Lawndale" ,
...
60616 => "Armour Square, Bridgeport, Douglas,Lower West Side (Pilsen), Near South Side", 
